...
import logging
from .models import Patient, Doctor, Appointment, User, PatientReconData, Message, Notification, TimeSlot , Rating,SPECIALIZATIONS,AIData,HistoryEntry,LOCATION_CHOICES
...
def RegisterDoctor(request):
    ...
    try:
        ...
        Doctor.objects.create(user=user, specialization=specialization, clinic_location=clinic_location, price=price ,  City=City)
